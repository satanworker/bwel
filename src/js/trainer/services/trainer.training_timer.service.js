...
TrainerTraining_timerService.$inject = ['$q', '$interval', '$timeout', 'localStorageService'];

function TrainerTraining_timerService($q, $interval, $timeout, localStorageService) {
  ...
  this.startTimer = function() {
    ...
    if (!!_timeStartTraining && !!_timeStopTraining) {
        console.log(!!_timeStartTraining , !!_timeStopTraining);
    }
...
export default TrainerTraining_timerService;
